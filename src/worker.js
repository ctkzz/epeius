...
const proxyIPs = ['cdn.anycast.eu.org','cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org','cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org','workers.cloudflare.cyou'];
